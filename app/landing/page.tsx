...
const INTEGRATIONS: IntegrationDetail[] = [
  {
    ...
    detail:
      'Plan, log, and reschedule ERP activities and to-dos straight from your calendar — your team stops jumping into the ERP just to check what\'s on.',
    capabilities: [
      'Create, edit, and reschedule activities directly from any calendar view',
      'Connect multiple ERP databases — each gets its own color',
      'To-dos appear in the unified tasks panel and the calendar',
      'Customer, project, and activity type all preserved',
      'Drag to reschedule — changes write back to ERP',
    ],
  },
  {
    name: 'Outlook',
    ...
    detail:
      'See your team\'s Outlook meetings and Microsoft To Do tasks next to everything else — one setup covers the whole company, no per-user signup.',
    capabilities: [
      'Read and create events, with RSVPs, attendees, and locations',
      'Microsoft To Do tasks read and write — in the unified tasks panel',
      'One setup covers your whole team',
      'Attach a Teams meeting link automatically when creating an event',
      'Drag to reschedule',
    ],
  },
  {
    ...
    calendars: true,
    tasks: 'partial',
    tasksNote: 'Personal mode only',
    parallel: 'Both modes can run together',
    detail:
      'Two ways to connect Google so it fits any company — each user plugs in their own account, or admins connect the whole Workspace at once.',
    capabilities: [
      'Personal: each user picks which calendars to show, with full read/write of Calendar and Google Tasks',
      'Workspace: one setup covers every user\'s calendars across the company',
      'Both modes can run side-by-side — no duplicate events',
      'Google Meet links attached automatically to bookings',
      'Share calendars with colleagues at four visibility levels',
    ],
  },
  {
    name: 'Zoom',
    type: 'Meeting Links',
    bg: '#2A8F94',
    sync: 'Generates links',
    calendars: false,
    tasks: 'no',
    parallel: 'One Zoom account covers the team',
    detail:
      'Spin up a Zoom meeting automatically whenever you create an event or accept a booking — no copy-pasting links.',
    capabilities: [
      'Auto-creates a Zoom meeting and embeds the join URL on event creation',
      'Pairs with any calendar source — ERP, Outlook, Google',
      'One Zoom account covers the whole organization',
    ],
  },
  {
    name: 'Calendly',
    ...
    calendars: true,
    tasks: 'no',
    parallel: 'One Calendly user, runs alongside any source',
    detail:
      'Bookings made in Calendly show up in your team view within seconds — keep the booking flow you have, see it where everyone else looks.',
    capabilities: [
      'New and cancelled bookings appear in the team view in real time',
      'Manage bookings in Calendly, see them everywhere else',
      'Runs alongside any other calendar source',
    ],
  },
  {
    name: 'Teams',
    ...
    detail:
      'Add a Teams meeting link to any event or booking with one click — nothing extra to set up if you have Outlook connected.',
    capabilities: [
      'Teams links auto-attached to events created through Outlook',
      'Pick Teams as the video target in any booking template',
      'Shares the Outlook setup — no separate connection',
    ],
  },
  {
    name: 'Google Meet',
    ...
    detail:
      'Add a Meet link to any event or booking with one click — nothing extra to set up if Google is connected.',
    capabilities: [
      'Meet links attached automatically to events created through Google',
      'Pick Meet as the video target in any booking template',
      'Works in both personal and Workspace modes',
    ],
  },
  {
    name: 'ICS Feeds',
    type: 'Any Calendar Feed',
    bg: '#7A4E9C',
    sync: 'Read-only',
    calendars: true,
    tasks: 'no',
    ...
    detail:
      'Drop in any calendar feed — Airbnb, school timetables, gym schedules, sports — and see it next to your work calendars so you never double-book your life.',
    capabilities: [
      'Events from the feed appear in the calendar (read-only)',
      'Multiple feeds per person, each with its own color and label',
      'Refreshes automatically; manual refresh available',
      'Works with any public calendar feed — no login',
      'Share personal feeds with colleagues at controlled visibility',
    ],
  },
  {
    ...
    parallel: 'Pairs with any other source',
    detail:
      'Plan and log Excellent Books activities and to-dos straight from your calendar — same depth as the Standard ERP integration.',
    capabilities: [
      'Same as Standard ERP — read/write events and tasks, multi-instance, color-coded',
  ...
  },
  {
    ...
    detail:
      'Public holidays show up automatically per person — so you don\'t accidentally book a meeting on someone\'s day off.',
    capabilities: [
      'Each person can have their own country (e.g. team in Latvia + remote contractor in Germany)',
      'Holidays block booking slots by default — templates can opt to allow them',
      'Visual banner on holiday dates',
    ],
  },
]
